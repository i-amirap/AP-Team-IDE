...
self.addEventListener("fetch", event => {
  ...
  if (event.request.mode === "navigate") {
    // فقط زمانی index.html رو برگردون که مسیر root باشه
    if (url.pathname === "/AP-Team-IDE/" || url.pathname === "/AP-Team-IDE/index.html") {
      event.respondWith(
      ...
      // برای صفحات دیگر، فایل خودشون رو از کش یا شبکه بفرست
      event.respondWith(
